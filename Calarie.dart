/*
Name: Calarie.dart
Purpose: File that runs the Calorie Calculator Code
Version: 1.0  6/7/20
Author(s): Ky-Khoa Nguyen (Main Author) & Vishal Tailor 
Dependencies: None
*/
...
class Calarie extends State<Jawn> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Calorie Calculator',style: TextStyle(fontSize:25.0,fontWeight: FontWeight.w300),),
        centerTitle: true,
      ),
      body: Container(
        child: Padding(
