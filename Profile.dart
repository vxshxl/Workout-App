/*
Name: Profile.dart
Purpose: Sets up the Profile portion of our app.
Version: 1.0  6/7/20
Author(s): Patrick Phang (Main) & Vishal Tailor 
Dependencies: None
*/
...
Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Profile",style: TextStyle(fontSize:25.0,fontWeight: FontWeight.w300),),),
          body: Padding(
