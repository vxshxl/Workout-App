/*
Name: calender.dart
Purpose: File that runs the Schedule code for our app
Version: 1.0  6/7/20
Author(s): Matthew Lucente
Dependencies: None
*/
...
class _MyHomePageState extends State<Calender> with TickerProviderStateMixin {
 ...
 Widget build(BuildContext context) {
   return Scaffold(
     ...
     appBar: AppBar(
       title: Text('Calender',style: TextStyle(fontSize:25.0,fontWeight: FontWeight.w300),),
     ),
     body: Column(
