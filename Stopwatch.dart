/*
Name: Stopwatch.dart
Purpose: Creates the Timer page for the app which enables
the user to not have to leave the app to time thier workouts
Version: 1.0  6/7/20
...
Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Stopwatch',style: TextStyle(fontSize:25.0,fontWeight: FontWeight.w300),),
        centerTitle: true,
      ),
  body: Container(
    child: Column(
